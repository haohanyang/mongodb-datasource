...
Here we show the code editor component used in the plugin, which has auto-completion, operator documentation preview on hovering, validation, syntax highlighting and more, crafted for MongoDB aggregation language.
